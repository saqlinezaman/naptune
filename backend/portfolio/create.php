...
<div class="row">
    <div class="col-12">
        ...
        <label for="exampleInputEmail1" class="form-label my-2">Portfolio image</label>
            ...
            <input name="subtitel" "email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            <!-- subtitel end -->

            <!-- titelstart -->
            <label for="exampleInputEmail1" class="form-label my-2">titel</label>
            <textarea name="titel" "email" class="form-control" rows="5" ></textarea>
            <!--titel  end -->

            <!--designation of Reviewer  end -->

            <button name="port-insert" type="submit" class="btn btn-primary mt-4"><i class="material-icons">add</i>Create</button>
        </form>
